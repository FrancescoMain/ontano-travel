...
const resources = {
  en: {
    translation: {
      ...
      "Automobile": "Car",
      "Furgone": "Van",
      "Camper/Minibus": "Camper/Minibus",
      "Moto/Scooter": "Motorcycle/Scooter",
      "Bicicletta/Surf": "Bicycle/Surf",
      "Rimorchio": "Trailer",
      // Tariffe - Sistemazioni
      "Passaggio Ponte": "Deck Passage",
      "Cabina 2 posti": "2-Bed Cabin",
      "Cabina 4 posti": "4-Bed Cabin",
      "Cabina 4 posti disabili": "4-Bed Cabin (Disabled)",
      "Cabina 4 posti con bagno": "4-Bed Cabin with Bathroom",
      "Letto 2 posti": "2-Bed Berth",
      // Veicoli - Form
      "Targa": "License Plate",
      "Carburante": "Fuel Type",
      "Aggiungi veicolo": "Add vehicle",
      "Veicolo": "Vehicle",
      "Rimuovi veicolo": "Remove vehicle",
      "Tipo": "Type",
      "Altezza (m)": "Height (m)",
      ...
      "Il tuo viaggio": "Your Trip",
      "Dettaglio Tour": "Tour Details",
      "Dati Fattura": "Invoice Data",
      "CONFERMA": "CONFIRM",
      "Totale": "Total",
      "Prezzo listino": "List Price",
      "Totale Biglietti": "Total Tickets",
      // Checkout - Tariffe e costi
      "Donazione": "Donation",
      ...
      "A quale email inviare il link": "Which email to send the link to",
      // Checkout - Fattura
      "Richiedo la fattura": "I request an invoice",
      "Nazione": "Country",
      ...
      // Checkout - Veicoli
      "Targa rimorchio": "Trailer License Plate",
      "Carburante rimorchio": "Trailer Fuel Type",
      "esclusi infant": "excludes infants",
      // Checkout - Errori
      "Inserire la targa per tutti i veicoli": "Enter license plate for all vehicles",
      ...
      "Reinvia email con biglietto": "Resend email with ticket",
  ...
  it: {
    translation: {
      ...
      "Bicicletta/Surf": "Bicicletta/Surf",
      "Rimorchio": "Rimorchio",
      // Tariffe - Sistemazioni
      "Passaggio Ponte": "Passaggio Ponte",
      "Cabina 2 posti": "Cabina 2 posti",
      "Cabina 4 posti": "Cabina 4 posti",
      "Cabina 4 posti disabili": "Cabina 4 posti disabili",
      "Cabina 4 posti con bagno": "Cabina 4 posti con bagno",
      "Letto 2 posti": "Letto 2 posti",
      // Veicoli - Form
      "Targa": "Targa",
      "Carburante": "Carburante",
      "Aggiungi veicolo": "Aggiungi veicolo",
      "Veicolo": "Veicolo",
      "Rimuovi veicolo": "Rimuovi veicolo",
      "Tipo": "Tipo",
      "Altezza (m)": "Altezza (m)",
      ...
      "Il tuo viaggio": "Il tuo viaggio",
      "Dettaglio Tour": "Dettaglio Tour",
      "Dati Fattura": "Dati Fattura",
      "CONFERMA": "CONFERMA",
      "Totale": "Totale",
      "Prezzo listino": "Prezzo listino",
      "Totale Biglietti": "Totale Biglietti",
      // Checkout - Tariffe e costi
      "Donazione": "Donazione",
      ...
      "A quale email inviare il link": "A quale email inviare il link",
      // Checkout - Fattura
      "Richiedo la fattura": "Richiedo la fattura",
      "Nazione": "Nazione",
      ...
      // Checkout - Veicoli
      "Targa rimorchio": "Targa rimorchio",
      "Carburante rimorchio": "Carburante rimorchio",
      "esclusi infant": "esclusi infant",
      // Checkout - Errori
      "Inserire la targa per tutti i veicoli": "Inserire la targa per tutti i veicoli",
      ...
      "Reinvia email con biglietto": "Reinvia email con biglietto",
